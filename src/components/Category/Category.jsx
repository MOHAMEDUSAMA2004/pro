...
import phone from '../../assets/CategoryCellPhone.png'
import camera from '../../assets/CategoryCamera.png'
import computer from '../../assets/CategoryComputer.png'
import gamepad from '../../assets/CategoryGamepad.png'
import headphone from '../../assets/CategoryHeadphone.png'
import smartwatch from '../../assets/CategorySmartWatch.png'
function Category() {
  return (
    <div className='mt-5'>
