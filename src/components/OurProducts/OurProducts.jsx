...
function OurProducts({products2 ,addToWishlist,addToCart,getItemFromDetails}) {
          ...
          products2.map((val,i)=>{
            return(
              <div key={i} className="card product_card border-0" >
                ...
                <Link  to={`product2/${val.id}`}><img src={val.image}  width={'200px'} height={'200px'} className="card-img-top mx-auto" alt="..." /></Link>
                <div className="add">
